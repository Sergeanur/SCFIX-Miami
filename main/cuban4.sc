...
GOTO cuban4_fool_compiler // SCFIX: remove flag_player_on_mission = 0 check
	...
	haitian_doorman2 = scplayer // SCFIX
	hait_defender3 = scplayer // SCFIX
	hait_defender4 = scplayer // SCFIX
	hait_defender5 = scplayer // SCFIX
	random_haitian1 = scplayer // SCFIX
	random_haitian2 = scplayer // SCFIX
	random_haitian3 = scplayer // SCFIX
cuban4_fool_compiler: // SCFIX: remove flag_player_on_mission = 0 check
...
//pepe
CREATE_CHAR PEDTYPE_GANG_CUBAN CBb -1170.0 -607.0 10.6 cuban_trojan1 // SCFIX: create as Cuban now, recreate as golfer later
...
SET_ANIM_GROUP_FOR_CHAR haitian_sniper ANIM_PLAYER_2ARMED_PED // SCFIX
...
IF plyr_in_hait_car = 1
	...
	// ******************************************START OF CUTSCENE******************************
							...
							// SCFIX: START - recreate Pepe now as GOLFER
...
REQUEST_MODEL buildblown // SCFIX
REQUEST_MODEL hdrugfactorypol // SCFIX
REQUEST_MODEL LODldblown // SCFIX
...
IF NOT IS_CAR_DEAD trojan_horse2 
	...
	AND IS_CAR_IN_AREA_2D trojan_horse2 -1198.782 64.841 -1157.978 109.155 FALSE // SCFIX
...
IF NOT IS_CAR_DEAD trojan_horse3
	...
	AND IS_CAR_IN_AREA_2D trojan_horse3 -1198.782 64.841 -1157.978 109.155 FALSE // SCFIX
...
WHILE GET_FADING_STATUS
OR NOT HAS_MODEL_LOADED buildblown // SCFIX
OR NOT HAS_MODEL_LOADED hdrugfactorypol // SCFIX
OR NOT HAS_MODEL_LOADED LODldblown // SCFIX
	WAIT 0
ENDWHILE
...
MARK_MODEL_AS_NO_LONGER_NEEDED buildblown // SCFIX
MARK_MODEL_AS_NO_LONGER_NEEDED hdrugfactorypol // SCFIX
MARK_MODEL_AS_NO_LONGER_NEEDED LODldblown // SCFIX
...
CLEAR_THREAT_FOR_PED_TYPE PEDTYPE_GANG_HAITIAN THREAT_PLAYER1 // SCFIX
...
SET_ZONE_PED_INFO GHETTO2 DAY   (13) 150 0 0 0 0 0 0 0 0 20 //Cubans // SCFIX: set 100 to 150 (like in inital.sc)
SET_ZONE_PED_INFO GHETTO2 NIGHT (10) 150 0 0 0 0 0 0 0 0 10 // SCFIX: set 100 to 150 (like in inital.sc)
SET_ZONE_CAR_INFO GHETTO2 DAY   (12) 200 0 0 0 0 0 0 0 0 10 // SCFIX: set 100 to 200 (like in inital.sc)
SET_ZONE_CAR_INFO GHETTO2 NIGHT (10) 200 0 0 0 0 0 0 0 0 10 // SCFIX: set 100 to 200 (like in inital.sc)
//CLEAR_THREAT_FOR_PED_TYPE PEDTYPE_GANG_HAITIAN THREAT_GANG_CUBAN // SCFIX: why? this makes no sense
//CLEAR_THREAT_FOR_PED_TYPE PEDTYPE_GANG_CUBAN THREAT_GANG_HAITIAN // SCFIX: why? this makes no sense
IF bomb_timer = 0
...
IF NOT IS_CHAR_DEAD haitian_engineer3 
	...
	SET_CHAR_THREAT_SEARCH haitian_engineer3 THREAT_GANG_GOLFER // SCFIX
...
IF NOT IS_CHAR_DEAD haitian_engineer4 
	...
	SET_CHAR_THREAT_SEARCH haitian_engineer4 THREAT_GANG_GOLFER // SCFIX
...
IF NOT IS_CHAR_DEAD hait_defender1 
	...
	SET_CHAR_THREAT_SEARCH hait_defender1 THREAT_GANG_GOLFER // SCFIX
...
IF NOT IS_CHAR_DEAD hait_defender2 
	...
	SET_CHAR_THREAT_SEARCH hait_defender2 THREAT_GANG_GOLFER // SCFIX
...
IF NOT IS_CHAR_DEAD haitian_doorman 
	...
	SET_CHAR_THREAT_SEARCH haitian_doorman THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH haitian_doorman2 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH hait_defender3 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH hait_defender4 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH hait_defender5 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH random_haitian1 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH random_haitian2 THREAT_GANG_GOLFER // SCFIX
...
SET_CHAR_THREAT_SEARCH random_haitian3 THREAT_GANG_GOLFER // SCFIX
