...
REQUEST_MODEL buildblown // FIXMIAMI
REQUEST_MODEL hdrugfactorypol // FIXMIAMI
REQUEST_MODEL LODldblown // FIXMIAMI
...
WHILE GET_FADING_STATUS
OR NOT HAS_MODEL_LOADED buildblown // FIXMIAMI
OR NOT HAS_MODEL_LOADED hdrugfactorypol // FIXMIAMI
OR NOT HAS_MODEL_LOADED LODldblown // FIXMIAMI
	WAIT 0
ENDWHILE
...
MARK_MODEL_AS_NO_LONGER_NEEDED buildblown // FIXMIAMI
MARK_MODEL_AS_NO_LONGER_NEEDED hdrugfactorypol // FIXMIAMI
MARK_MODEL_AS_NO_LONGER_NEEDED LODldblown // FIXMIAMI
...
SET_ZONE_PED_INFO GHETTO2 DAY   (13) 150 0 0 0 0 0 0 0 0 20 //Cubans // FIXMIAMI: set 100 to 150 (like in inital.sc)
SET_ZONE_PED_INFO GHETTO2 NIGHT (10) 150 0 0 0 0 0 0 0 0 10 // FIXMIAMI: set 100 to 150 (like in inital.sc)
SET_ZONE_CAR_INFO GHETTO2 DAY   (12) 200 0 0 0 0 0 0 0 0 10 // FIXMIAMI: set 100 to 200 (like in inital.sc)
SET_ZONE_CAR_INFO GHETTO2 NIGHT (10) 200 0 0 0 0 0 0 0 0 10 // FIXMIAMI: set 100 to 200 (like in inital.sc)
//CLEAR_THREAT_FOR_PED_TYPE PEDTYPE_GANG_HAITIAN THREAT_GANG_CUBAN // FIXMIAMI: why? this makes no sense
//CLEAR_THREAT_FOR_PED_TYPE PEDTYPE_GANG_CUBAN THREAT_GANG_HAITIAN // FIXMIAMI: why? this makes no sense
IF bomb_timer = 0
