...
WHILE NOT LOCATE_PLAYER_ANY_MEANS_3D Player1 89.1 1084.0 39.0 6.0 6.0 6.0 FALSE
	...
	AND TIMERB > 4000 // SCFIX: change 3000 to 4000
		IF audio_is_loading = 0
	...
	AND TIMERB > 2500
		...
		IF audio_has_loaded = 1
			...
			IF HAS_MISSION_AUDIO_FINISHED 1
				CLEAR_THIS_PRINT COK2_17 // SCFIX
...
WHILE NOT deathkills > 9 //North of centre building (SWARM 3!!!)
	...
	IF NOT IS_CAR_DEAD buddy_heli
		...
		ELSE // SCFIX
			IF HAS_MISSION_AUDIO_FINISHED 1 // SCFIX
				CLEAR_THIS_PRINT COK2_21 // SCFIX
			ENDIF // SCFIX
		ENDIF
	ENDIF
	...
	IF NOT IS_CHAR_DEAD sgang_boss
		WHILE first_two_samples = 0
			...
			IF audio_has_loaded = 1
				...
				IF HAS_MISSION_AUDIO_FINISHED 1
					CLEAR_THIS_PRINT COK2_27 // SCFIX
					IF NOT IS_CHAR_DEAD sgang_boss
						IF NOT IS_CAR_DEAD buddy_heli
...
WHILE NOT LOCATE_PLAYER_ANY_MEANS_3D Player1 33.7 1083.0 15.0 10.0 10.0 4.0 FALSE // SCFIX: change X and Y radius from 6 to 10
	WAIT 0
...
IF NOT IS_CAR_DEAD buddy_heli
	...
	CREATE_CHAR_AS_PASSENGER buddy_heli PEDTYPE_CIVMALE null 0 stunt_double2 // SCFIX: was PEDTYPE_CIVFEMALE
ENDIF
